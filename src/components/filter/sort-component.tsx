        ...
        <div className="bg-white py-2" style={{ overflow: 'auto' }}>
          <div className="w-100 fml-grid justify-content-center justify-content-md-between">
            {sortParams.map((i) => (
              <div
                key={i.id}
                className="d-flex justify-content-start align-items-center py-3 px-2"
              >
                <div>
                  <SortIconTag
                    ...
                    isselected={
                      checkId === i.id && sortInfo[i.title] === 'ascend'
                        ? 'true'
                        : 'false'
                    }
                  />
                  <SortIconTag
                    ...
                    isselected={
                      checkId === i.id && sortInfo[i.title] === 'descend'
                        ? 'true'
                        : 'false'
                    }
                  />
                ...
                <SortText
                  className="m-0 mx-3"
                  isselected={checkId === i.id ? 'true' : 'false'}
                >
                  {i.title}
                </SortText>
              </div>
