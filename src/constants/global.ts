...
// Notice
export const EXPIRATIONDATE = 12
const CURRENTDATE = new Date().getDate()
const EXPIRATIONNOTICESTARTDATE = 9
const EXPIRATIONNOTICEENDDATE = 12
const POSTEXPIRATIONNOTICEENDDATE = EXPIRATIONNOTICEENDDATE + 1
const NOTICEPERIOD =
  CURRENTDATE >= EXPIRATIONNOTICESTARTDATE &&
  CURRENTDATE <= EXPIRATIONNOTICEENDDATE
const POSTNOTICEPERIOD = CURRENTDATE >= POSTEXPIRATIONNOTICEENDDATE

export const VOTINGEXPIRED = CURRENTDATE >= EXPIRATIONDATE
export const NOTICE = NOTICEPERIOD
  ? `Voting ends on the ${EXPIRATIONDATE}th of January, 2023`
  : POSTNOTICEPERIOD
  ? `Voting has ended`
  : ''
